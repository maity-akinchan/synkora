...
export default function SearchBar({ placeholderText }: SearchBarProps) {
    return (
        <div className="flex items-center gap-3 border-2 p-1 rounded-full w-7/12">
            ...
            />
            <p className="p-1 bg-[var(--background-alt)] rounded-3xl hover:bg-[var(--foreground)] hover:text-[var(--background)]">
