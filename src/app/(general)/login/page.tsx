  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[var(--background)] text-[var(--foreground)]">
      <div className="max-w-md w-full p-6 border rounded-lg shadow-md bg-[var(--muted)]">
        ...
        <form ref={formRef} onSubmit={(e) => {isLogin ? onLogin(e, setErrorState, setErrorMessage, resetForm) : onSignup(e, setErrorState, setErrorMessage, resetForm)}} className="space-y-4">
          {!isLogin && (
            <input
              type="text"
              placeholder="Name"
